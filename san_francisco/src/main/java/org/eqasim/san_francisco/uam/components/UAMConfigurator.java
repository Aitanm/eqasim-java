...
public class UAMConfigurator {
	...
	static public void configure(Config config) {
		...
		eqasimConfig.setEstimator("uam", UAMModeChoiceModule.UAM_ESTIMATOR_NAME); //TODO Create class and method
	...
	static public void configureController(Controler controller, CommandLine cmd, UAMConfigGroup UAMConfig, Config config) {
		...
		//TODO checkout possible erros due to the EnrichedTransitRoute differences in the eqasim and uam versions
		...
		controller.addOverridingModule(new UAMModule(uamManager, controller.getScenario(), networkUAM, networkCar));
