...
public class UAMPredictor {
	...
	public UAMPredictor(UAMManager manager, Scenario scenario, WaitingStationData waitingData, UAMConfigGroup uamConfig,
			TransitConfigGroup transitConfigGroup, Set<String> availableModes, Network carNetwork,
			LeastCostPathCalculator plcpccar, TripRouter transitRouter, CustomModeChoiceParameters parameters,
			UAMStationConnectionGraph stationConnectionutilities, SubscriptionFinder subscriptions) {
